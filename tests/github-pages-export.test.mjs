...
test("exports a self-contained GitHub Pages project site", async () => {
  ...
  assert.match(html, /\/Robotic-0\/assets\/main-overview-20260902\.svg/);
  assert.match(html, /\/Robotic-0\/assets\/embodied-agent-20260902\.svg/);
  ...
  await Promise.all([
    ...
    access(new URL("assets/main-overview-20260902.svg", output)),
    access(new URL("assets/embodied-agent-20260902.svg", output)),
